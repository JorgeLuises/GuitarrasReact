...
export default function Header({ carrito, eliminarItem, incrementarCantidad, decrementarCantidad, vaciarCarrito }) {
    //State derivado
    const isEmpty = useMemo(() => carrito.length === 0, [carrito]);
    const precioTotal = useMemo(() => carrito.reduce((total, guitarra) => total + (guitarra.price * guitarra.cantidad), 0), [carrito]);
                                                            ...
                                                            <tr key={index}>
                                                                ...
                                                                <td>
                                                                    <button
                                                                        ...
                                                                        type="button"
                                                                        onClick={() => eliminarItem(guitarra.id)}
                                                                    >
                                                                        X
                                                                    </button>
                                                                </td>
